...
fun NotificationManager.sendNotification(message: String, context: Context, downloadedFile: String, status: String) {
    ...
    val notificationBuilder = NotificationCompat.Builder(context, context.getString(R.string.notification_downloaded_channel_id))
